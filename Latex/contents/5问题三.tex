...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figs/5问题三/图_最优K值决策图.png}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figs/5问题三/图_KMeans聚类结果.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figs/5问题三/图_检测误差敏感性分析.png}
